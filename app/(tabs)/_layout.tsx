...
export default function TabLayout() {
  ...
  return (
    ...
    >
      ...
      />
      <Tabs.Screen name="AuthScreen" options={{ tabBarButton: () => null }} />
      <Tabs.Screen name="ChatScreen" options={{ tabBarButton: () => null }} />
      <Tabs.Screen name="LoginScreen" options={{ tabBarButton: () => true }} />
      <Tabs.Screen name="SignUpScreen" options={{ tabBarButton: () => true }} />
    </Tabs>
  );
}
